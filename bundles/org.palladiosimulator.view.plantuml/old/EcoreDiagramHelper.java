...
public class EcoreDiagramHelper {
	...
	public static String PLANTUML_ANNOTATION_KEY = "org.palladiosimulator.view.plantuml.plantuml";
	...
	protected Map<String, String> getSkinParams(final String qualifier, final EAnnotation annotation,
	...
	public String getEObjectHyperlink(final EObject eObject) {
		...
		if (uri.isPlatformResource()) {
			...
			return MarkerLinkOpener.createMarkerLink(EValidator.MARKER, path, EValidator.URI_ATTRIBUTE,
